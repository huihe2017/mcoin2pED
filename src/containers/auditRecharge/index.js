        ...
        return (
            <div className={style.wlop}>
                ...
                <div className={style.table}>
                    <Table pagination={{total:this.props.wallet.auditRechargeList.pager.total,pageSize:this.props.wallet.auditRechargeList.pager.pageSize}} onChange={(pagination) => {
                        this.props.getRechargeAuditList({
                            page:pagination.current,
                            currency:this.state.currency
                        })
                    }} columns={columns} dataSource={this.props.wallet.auditRechargeList.list}/>
                </div>
            </div>
